...
public class Horse extends AnimalEntity {


    public Horse(boolean isDead, double weight, int speed, double maxFood, int maxGroupSize, AnimalType animalType, AnimalName animalName, String icon, double currentWeight) {
