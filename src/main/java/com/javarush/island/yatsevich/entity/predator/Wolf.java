...
public class Wolf extends AnimalEntity {


    public Wolf(boolean isDead, double weight, int speed, double maxFood, int maxGroupSize, AnimalType animalType, AnimalName animalName, String icon, double currentWeight) {
